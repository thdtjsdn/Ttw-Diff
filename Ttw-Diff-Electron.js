...
}});global.win.webContents.openDevTools();global.win.on("closed",function(e){global.win=null;});
//----------------------------------------------------------------------------------------------------;
...
global.initialized = function()
{
	...
	global.win.webContents.executeJavaScript( 'require( global.process.cwd() + "/Ttw-Diff.js" );' );
...
global.win.loadURL( global.REQUIRES.url.format({ pathname : global.process.cwd() + "/root/index.html", protocol : "file:", slashes : true }));
